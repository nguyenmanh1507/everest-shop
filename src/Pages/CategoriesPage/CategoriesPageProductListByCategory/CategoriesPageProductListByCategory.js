...
class CategoriesPageProductListByCategory extends Component<{}> {
  render() {
    return (
      <GridX>
        {data.map((d, index) => (
          ...
          >
            <CardSeel
              imgSrc={`https://unsplash.it/270/360?image=12${index}`}
...
export default CategoriesPageProductListByCategory
